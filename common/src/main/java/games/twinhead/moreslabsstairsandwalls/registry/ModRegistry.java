    ...
    public static Block getBlock(ModBlocks block, ModBlocks.BlockType type)
    {
        return switch (block) {
            ...
            case OXIDIZED_COPPER,
                 ...
                 OXIDIZED_CHISELED_COPPER-> switch (type)
            {
        ...
        return switch (block.modelType){
            case LEAVES -> switch (block) {
                case    OAK_LEAVES,
                        ...
                        ACACIA_LEAVES,
                        DARK_OAK_LEAVES,
                        MANGROVE_LEAVES -> (state, world, pos, tintIndex) -> world != null && pos != null ? BiomeColors.getAverageFoliageColor(world, pos) : FoliageColor.getMangroveColor();
        ...
        return switch (block.modelType){
            case LEAVES -> switch (block) {
                case    OAK_LEAVES,
                        ...
                        ACACIA_LEAVES,
                        DARK_OAK_LEAVES,
                        MANGROVE_LEAVES -> (stack, tintIndex) -> FoliageColor.getMangroveColor();
