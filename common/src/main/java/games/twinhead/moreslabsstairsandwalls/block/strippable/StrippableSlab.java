...
public class StrippableSlab extends BaseSlab {
    ...
    public StrippableSlab(ModBlocks strippedBlock, AbstractBlock.Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!world.isClient) {
            world.setBlockState(pos, strippedBlock.getBlock(ModBlocks.BlockType.SLAB).getStateWithProperties(state));
