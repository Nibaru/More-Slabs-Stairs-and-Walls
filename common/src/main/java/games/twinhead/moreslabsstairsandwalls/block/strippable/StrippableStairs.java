...
public class StrippableStairs extends BaseStairs {
    ...
    public StrippableStairs(BlockState defaultState, ModBlocks strippedBlock, Settings settings) {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!world.isClient) {
            world.setBlockState(pos, strippedBlock.getBlock(ModBlocks.BlockType.STAIRS).getStateWithProperties(state));
