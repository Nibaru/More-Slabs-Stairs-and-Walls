...
public enum ModBlocks {
    ...
    GRASS_BLOCK(Blocks.GRASS_BLOCK, ToolType.SHOVEL, Layer.CUTOUT_MIPPED, "grass_block_side", "grass_block_top", "dirt"),
    MYCELIUM(Blocks.MYCELIUM, ToolType.SHOVEL, Layer.CUTOUT_MIPPED, "mycelium_side", "mycelium_top", "dirt"),
    PODZOL(Blocks.PODZOL, ToolType.SHOVEL, Layer.CUTOUT_MIPPED, "podzol_side", "podzol_top", "dirt"),
    ...
    public Identifier getIdentifier(BlockType blockType){
        return new Identifier(MoreBuildingBlocks.mod_id, this + "_" + blockType);
    }
