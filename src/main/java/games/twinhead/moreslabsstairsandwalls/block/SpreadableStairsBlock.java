...
public class SpreadableStairsBlock extends StairsBlock implements Waterloggable, Fertilizable {

    public static final BooleanProperty SNOWY;

    public SpreadableStairsBlock(BlockState baseBlockState, Settings settings) {
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        if (!canSurvive(state, world, pos)) {
            if(state.isOf(ModBlocks.GRASS_BLOCK_STAIRS.get())) {
                world.setBlockState(pos, ModBlocks.DIRT_STAIRS.get().getStateWithProperties(world.getBlockState(pos)), Block.NOTIFY_LISTENERS);
            }else if(state.isOf(ModBlocks.MYCELIUM_STAIRS.get())) {
                world.setBlockState(pos, ModBlocks.DIRT_STAIRS.get().getStateWithProperties(world.getBlockState(pos)), Block.NOTIFY_LISTENERS);
            }else if(state.isOf(ModBlocks.WARPED_NYLIUM_STAIRS.get())) {
                world.setBlockState(pos, ModBlocks.NETHERRACK_STAIRS.get().getStateWithProperties(world.getBlockState(pos)), Block.NOTIFY_LISTENERS);
            }else if(state.isOf(ModBlocks.CRIMSON_NYLIUM_STAIRS.get())) {
                world.setBlockState(pos, ModBlocks.NETHERRACK_STAIRS.get().getStateWithProperties(world.getBlockState(pos)), Block.NOTIFY_LISTENERS);
            }  else {
