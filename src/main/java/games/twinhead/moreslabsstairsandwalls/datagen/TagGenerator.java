...
public class TagGenerator extends FabricTagProvider<Block> {
    ...
    protected void generateTags() {
        TagKey<Block> mineablePickaxe = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "mineable/pickaxe"));
        TagKey<Block> mineableShovel = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "mineable/shovel"));
        TagKey<Block> mineableHoe = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "mineable/hoe"));
        TagKey<Block> mineableAxe = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "mineable/axe"));

        TagKey<Block> beacon = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "beacon_base_blocks"));

        TagKey<Block> dirt = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "dirt"));

        TagKey<Block> slabs = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "slabs"));
        TagKey<Block> walls = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "walls"));
        TagKey<Block> stairs = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "stairs"));

        TagKey<Block> mushroom = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "mushroom_grow_block"));
        TagKey<Block> nylium = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "nylium"));

        TagKey<Block> wool = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "wool"));

        TagKey<Block> witherBaseBlocks = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "wither_summon_base_blocks"));
        TagKey<Block> soulFire = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "soul_fire_based_blocks"));
        TagKey<Block> soulSpeed = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "soul_speed_blocks"));

        TagKey<Block> dragonImmune = TagKey.of(Registry.BLOCK_KEY, new Identifier("minecraft", "dragon_immune"));
